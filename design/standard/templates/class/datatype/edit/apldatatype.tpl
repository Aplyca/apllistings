...
<input type="text" name="ContentClass_pricerange_default_num_rows_{$class_attribute.id}" value="{$class_attribute.data_int1|wash}"  size="8" maxlength="20" />
</div>
...
<tr class="{$Columns.sequence}">
    ...
    {* Remove. *}
    <td><input type="checkbox" name="ContentClass_data_pricerange_column_remove_{$class_attribute.id}[]" value="{$Columns.index}" /></td>

    {* Column. *}
    <td><input class="box" type="text" name="ContentClass_data_pricerange_column_name_{$class_attribute.id}[]" value="{$Columns.item.name|wash}" size="10" maxlength="255" /></td>

    {* Identifier. *}
    <td><input class="box" type="text" name="ContentClass_data_pricerange_column_id_{$class_attribute.id}[]" value="{$Columns.item.identifier|wash}" size="10" maxlength="255" /></td>
...
<input class="button" type="submit" name="CustomActionButton[{$class_attribute.id}_new_pricerange_column]" value="{'New column'|i18n('design/standard/class/datatype')}" title="{'Add a new column.'|i18n( 'design/standard/class/datatype' )}" />
</fieldset>
</div>
